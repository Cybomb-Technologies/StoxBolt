...
const UserRegister = () => {
  ...
  const metaPropsData = {
    title: "Sign Up for StoxBolt - Create Your Financial Dashboard",
    description:
      "Create your StoxBolt account today to access real-time financial news, market analysis, and investment insights. Secure registration with email or Google.",
    keyword:
      "stoxbolt signup, create account, user registration, financial dashboard, secure registration",
    image: "https://www.stoxbolt.com/images/logo.png",
    url: "https://www.stoxbolt.com/user-register",
  };
