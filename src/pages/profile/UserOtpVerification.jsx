...
import { Zap, ArrowLeft, Clock, Mail, X } from 'lucide-react';

const UserOtpVerifications = forwardRef(({ email: propEmail, onSuccess, onClose }, ref) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <motion.div
        ...
        className="bg-white rounded-2xl shadow-2xl w-full max-w-md border border-gray-200 relative"
      >
        {/* Close button */}
        <button
            ...
            <div className="space-y-4">
              ...
              <div className="text-center">
                ...
                <Button
                  ...
                  className="w-full border-2 border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-gray-300 px-6 py-2 font-medium shadow-sm hover:shadow transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {resendLoading ? (
                    <span className="flex items-center justify-center">
...
UserOtpVerification.displayName = 'UserOtpVerification';
