...
const UserLogin = () => {
  ...
  const metaPropsData = {
    title: "Sign In to StoxBolt - Access Your Financial Dashboard",
    description:
      "Log in to your StoxBolt account for real-time financial news, market analysis, and investment insights. Secure access with email or Google authentication.",
    keyword:
      "stoxbolt login, financial dashboard, user authentication, secure login, account access",
    image: "https://www.stoxbolt.com/images/logo.png",
    url: "https://www.stoxbolt.com/user-login",
  };
