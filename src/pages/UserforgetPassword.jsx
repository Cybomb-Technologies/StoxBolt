...
const UserForgetPassword = () => {
  ...
  const [step, setStep] = useState(1); // 1: Enter email, 2: OTP sent message
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API_URL}/api/user-auth/forgot-password/send-otp`,
        {
          method: "POST",
          headers: {
  ...
  const metaPropsData = {
    title: "Reset Your Password Now - StoxBolt Account Recovery",
    description:
      "Reset your StoxBolt password securely today. Enter your email address to receive a verification OTP and quickly regain access to your financial dashboard.",
    keyword:
      "reset password, forgot password, account recovery, stoxbolt password, secure reset",
    image: "https://www.stoxbolt.com/images/logo.png",
    url: "https://www.stoxbolt.com/user-forget-password",
  };
            ...
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mb-6">
                  Please check your inbox (and spam folder) for the OTP. It will
